...
- توی گروه، «میو» باید هر ۵ دقیقه برسه.
...
- گروه بیشتر: `send.py` از چند گروه پشتیبانی می‌کنه — توی Secret به نام
  `TELEGRAM_CHAT_ID` آیدی گروه‌ها رو با ویرگول جدا کن (مثلاً `-1003870033750,-1002222222222`).
