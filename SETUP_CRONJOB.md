# راهنمای ارسال دقیق هر ۱۶ دقیقه (cron-job.org)

کرون خودِ گیتهاب نامطمئنه (گاهی تا ۱ ساعت دیر اجرا میشه). برای اینکه «میو» **دقیقاً** هر ۱۶ دقیقه بره، از سرویس رایگان **cron-job.org** استفاده میکنیم که هر ۱۶ دقیقه به گیتهاب میگه «الان بفرست». این فقط **یک بار** انجام میشه.
...
- از این لینک: https://github.com/MatinUchiha-shadow/meow-sender/actions — باید هر ۱۶ دقیقه یه ران جدید با **event: workflow_dispatch** بیاد.
- توی گروه، «میو» باید هر ۱۶ دقیقه برسه.
